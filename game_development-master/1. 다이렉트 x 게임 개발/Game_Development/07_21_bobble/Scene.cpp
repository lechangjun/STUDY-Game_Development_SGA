...
void InitScene()
{
	...
	case 2: //빨간색			   		   
		...
		break;
	case 3: //노란색			   		   
		nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", shaderFile, 11, 1241, 28, 1257);
		break;
	case 4: //초록색			   		   
		nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", shaderFile, 11, 1268, 28, 1284);
		break;
	case 5: //보라색			   		   
	...
	case 2: //빨간색			   		   
		...
		break;
	case 3: //노란색			   		   
		next_nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", shaderFile, 11, 1241, 28, 1257);
		break;
	case 4: //초록색			   		   
		next_nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", shaderFile, 11, 1268, 28, 1284);
		break;
	case 5: //보라색			   		   
...
void Update()
{
	...
	if (bubbles.size() > 2) //생성된 버블이 3개 이상일 때
	{
		...
		//		break;
		//	}
		//	if (visit[Py][Px] == 10) continue;
		//	visit[Py][Px] = 10;//10은 방문
		...
		//		while (Qy.empty() == false)
		//		{
		//			int cy = Qy.front(); Qy.pop();//cy = 현재y좌표
		//			int cx = Qx.front(); Qx.pop();//cx = 현재x좌표
		...
		//				break;
		//			}
		//			if (visit[cy][cx] == 10) continue;
		//			visit[cy][cx] = 10;//10은 방문
	...
	{ //버블 생성 및 발사
		...
		case 2: //빨간색			   		   
			...
			break;
		case 3: //노란색			   		   
			nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", file, 11, 1241, 28, 1257);
			break;
		case 4: //초록색			   		   
			nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", file, 11, 1268, 28, 1284);
			break;
		case 5: //보라색			   		   
		...
		case 2: //빨간색			   		   
			...
			break;
		case 3: //노란색			   		   
			next_nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", file, 11, 1241, 28, 1257);
			break;
		case 4: //초록색			   		   
			next_nextbubbles = new Sprite(L"../_Textures/PuzzleBobble/PuzzleBobble.png", file, 11, 1268, 28, 1284);
			break;
		case 5: //보라색			   		   
	...
	for (int i = 0; i < bubbles.size(); i++)
	{
		...
		else if (bubbles[i]->Position().y + bubbles[i]->Scale().y / 2 > Height - (106 + bubbles[i]->Scale().y)) //2번째 줄
		{
			...
			else if (bubbles[i]->Position().x >= 582 && bubbles[i]->Position().x < 660 && (line[0][5] || line[0][6] || line[1][4] || line[1][6]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
			...
			else if (bubbles[i]->Position().x >= 660 && bubbles[i]->Position().x < 714 && (line[0][6] || line[0][7] || line[1][5]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(674, Height - (106 + bubbles[i]->Scale().y));
		...
		else if (bubbles[i]->Position().y + bubbles[i]->Scale().y / 2 > Height - (106 + bubbles[i]->Scale().y * 3)) //4번째 줄
		{
			...
			else if (bubbles[i]->Position().x >= 582 && bubbles[i]->Position().x < 660 && (line[2][5] || line[2][6] || line[3][4] || line[3][6]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
			...
			else if (bubbles[i]->Position().x >= 660 && bubbles[i]->Position().x < 714 && (line[2][6] || line[2][7] || line[3][5]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(674, Height - (106 + bubbles[i]->Scale().y * 3));
		...
		else if (bubbles[i]->Position().y + bubbles[i]->Scale().y / 2 > Height - (106 + bubbles[i]->Scale().y * 5)) //6번째 줄
		{
			...
			else if (bubbles[i]->Position().x >= 582 && bubbles[i]->Position().x < 660 && (line[4][5] || line[4][6] || line[5][4] || line[5][6]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
			...
			else if (bubbles[i]->Position().x >= 660 && bubbles[i]->Position().x < 714 && (line[4][6] || line[4][7] || line[5][5]))
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(674, Height - (106 + bubbles[i]->Scale().y * 5));
		...
		else if (bubbles[i]->Position().y + bubbles[i]->Scale().y / 2 > Height - (106 + bubbles[i]->Scale().y * 6)) //7번째 줄
		{
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(328, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(376, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(426, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(478, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(530, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(582, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(634, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
			...
			{
				bubbles[i]->Velocity(D3DXVECTOR2(0, 0));
				bubbles[i]->Position(688, Height - (106 + bubbles[i]->Scale().y * 6) + 4);
				line[6][7] = bubbles[i]->Color();
				bubbles[i]->Location(6, 7);
			}
		}
		else if (bubbles[i]->Position().y + bubbles[i]->Scale().y > Height - (106 + bubbles[i]->Scale().y * 6) + 4+3) //7번째 줄 아래
		{
