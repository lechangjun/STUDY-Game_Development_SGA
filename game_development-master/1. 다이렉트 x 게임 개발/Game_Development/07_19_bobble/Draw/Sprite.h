...
public:
	...
	Sprite(wstring textureFile, wstring shaderFile, float startX, float startY, float endX, float endY, float rotation);
	virtual ~Sprite();
...
private:
	void Initialize(wstring textureFile, wstring shaderFile, float startX, float startY, float endX, float endY , float rotation);
	void UpdateWorld();
